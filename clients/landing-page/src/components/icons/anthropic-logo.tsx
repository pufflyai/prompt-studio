...
// Official Anthropic symbol from Anthropic's media resources press kit.
export const AnthropicLogo = (props: AnthropicLogoProps) => {
  const { size = 16 } = props;

  return (
    <svg width={size} height={size} viewBox="0 0 92 64" fill="none" aria-hidden>
