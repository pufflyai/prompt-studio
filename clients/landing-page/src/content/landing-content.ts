...
import { BadgeCheck, House, LayoutGrid, Scale, Sparkles } from "lucide-react";
...
export type LandingView = "start" | "why-prompt-studio" | "features" | "privacy" | "terms";
...
export const SIDEBAR_VIEWS: LandingView[] = ["start", "why-prompt-studio", "features"];
