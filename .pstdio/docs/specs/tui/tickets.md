...
│                                                        │
│────────────────────────────────────────────────────────│
│ j/k:nav  s:status  n:new  e:edit  i:impl  x:arch  ?:? │
└────────────────────────────────────────────────────────┘
...
│                                                        │
│────────────────────────────────────────────────────────│
│ Esc:back  e:edit status  i:implement  x:archive  ?:?   │
└────────────────────────────────────────────────────────┘
```
...
Status group headers are not selectable — `j`/`k` skip over them.
...
| `e` | Edit status of selected ticket             |
...
| Key | Action                                |
| --- | ------------------------------------- |
| `e` | Edit status (opens status picker)     |
...
Opens a picker overlay listing all statuses for the project. `j`/`k` to navigate, `Enter` to select. Calls `PATCH /tickets/{id}` with the new status. Available from both list and content panels.
...
| `panels/status-picker.tsx`   | Overlay for picking ticket status |
