...
Extension commands, terminals, and dependency installers start from an allowlisted host environment instead of
inheriting the API process environment. The inherited keys are `BUN_INSTALL`, `BUN_INSTALL_CACHE_DIR`, `COLORTERM`,
