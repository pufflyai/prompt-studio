...
| `PSTDIO_DEFAULT_EXTENSIONS` | `["pstdio-core-skills","pstdio-core-templates","pstdio-core-workspace"]` | JSON array or `{ "defaultExtensions": [...] }` object installed and enabled for new projects. Tests can set `[]`. |
