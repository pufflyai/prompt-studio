...
Implementation automation (for example automatically starting work) is configured with extensions, not with status metadata. See `.pstdio/docs/product/cli/hooks.md` for lifecycle automation behavior.
