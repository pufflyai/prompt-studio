...
import { AlertMessage, ScrollArea } from "@pstdio/ui";
import { type Param, ParamEditor, type ParamEditorProps } from "@pstdio/ui/param-editor";
...
export const ImplementationSettingsPanel = (props: { host: GuestHost; t: Translate }) => {
  const { host, t } = props;
