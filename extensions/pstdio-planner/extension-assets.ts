...
export const plannerTemplateAssets = [
  ...
  { id: "bug_fix", title: "Bug fix", type: "ticket", path: "templates/tickets/bug-fix.ticket.md" },
  ...
  { id: "review_code", title: "Review code", type: "prompt", path: "templates/prompts/review-code.prompt.md" },
  {
    id: "commit_message",
