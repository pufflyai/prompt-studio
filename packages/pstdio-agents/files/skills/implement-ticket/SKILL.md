...
To be considered complete and ready for review, a ticket should produce "Validation Artifacts": **verifiable outputs** generated while doing the ticket, e.g. by running `<validation-command> > .pstdio/tickets/<shorthand>/artifacts/<artifact> 2>&1`
