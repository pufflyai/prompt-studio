...
describe("ticket creation via API with content field", () => {
  test("sets display_title and file_id when content is provided", async () => {
  ...
  test("ticket created with content is visible via CLI list with display_title", async () => {
  ...
  test("ticket file content is downloadable after creation with content", async () => {
