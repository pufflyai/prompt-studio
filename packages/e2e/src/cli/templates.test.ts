...
describe("pstdio templates list", () => {
  test("lists bundled templates after project creation", () => {
...
describe("pstdio templates create", () => {
  test("creates a custom template from file", () => {
...
describe("pstdio templates update", () => {
  test("updates template content and default", () => {
  ...
  test("fails for nonexistent template", () => {
...
describe("pstdio templates delete", () => {
  test("deletes a template and hides it from list", () => {
...
describe("pstdio templates write", () => {
  test("writes a docs template to the filesystem and updates navigation", () => {
  ...
  test("writes a ticket template to an existing ticket directory", () => {
  ...
  test("fails when ticket directory does not exist", () => {
  ...
  test("fails when using ticket template for docs target", () => {
