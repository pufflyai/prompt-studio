...
describe("pstdio tickets archive", () => {
  ...
  test("archived ticket is excluded from list by default", () => {
  ...
  test("archived ticket visible with --archived flag", () => {
  ...
  test("fails when archiving an already-archived ticket", () => {
