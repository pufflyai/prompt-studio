...
export const bridgeActionMessageType = "pstdio-shell.renderer-types.bridge-action";
...
export const rendererRows = [
  {
    id: reactRendererId,
    kind: "React",
    transport: "ShellWidgetRenderInput -> ReactNode",
  },
  {
    id: bridgeRendererId,
    kind: "Bridge",
    transport: "ShellWidgetRenderInput -> iframe bridge",
  },
];
