...
export interface ShellModeItem {
  id: string;
  title: string;
  subtitle: string;
  sections: ShellModeSection[];
}

export interface ShellModeFolder {
  id: string;
  label: string;
  icon: string;
  itemIds: string[];
...
export interface ShellModeRelated {
  label: string;
  hint: string;
  icon: string;
}

export interface ShellModeAction {
  id: string;
  label: string;
  icon: string;
}
...
export interface ShellMode {
  ...
  helperBody: string;
  relatedTitle: string;
  related: ShellModeRelated[];
  actions: ShellModeAction[];
  folders: ShellModeFolder[];
  items: ShellModeItem[];
  defaultItemId: string;
}

const notesMode: ShellMode = {
  id: "notes",
  label: "Notes",
  ...
  folders: [
    ...
    { id: "notes.notebook.work", label: "Work", icon: "Folder", itemIds: ["shell-demo-notes"] },
...
const mailMode: ShellMode = {
  ...
  folders: [
    { id: "mail.folder.inbox", label: "Inbox", icon: "Inbox", itemIds: ["thread-shell-demo", "thread-builds"] },
  ...
  defaultItemId: "thread-shell-demo",
  items: [
    {
      id: "thread-shell-demo",
      title: "Re: shell demo polish",
      subtitle: "Mira · 9:42",
      sections: [
        {
