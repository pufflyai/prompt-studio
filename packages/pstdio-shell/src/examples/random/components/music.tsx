...
import { itemResource, musicWidgetIds, randomShellModes, type ShellModeItem } from "../mock-data/data";
...
export const MusicTopBar = (props: { input: ShellWidgetRenderInput }) => {
...
export const MusicPlayer = (props: { input: ShellWidgetRenderInput }) => {
  const item = findActiveItem(props.input);
  return (
...
export const MusicQueue = (props: { input: ShellWidgetRenderInput }) => {
  const { input } = props;
