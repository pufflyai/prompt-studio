...
import { itemResource, mailWidgetIds, railWidgetId, randomResourceKind, randomShellModes } from "../mock-data/data";
...
const setupMailMode = (ctx: ShellModeActivationContext): Disposable[] => {
