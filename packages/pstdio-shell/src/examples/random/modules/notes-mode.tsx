...
import { itemResource, notesWidgetIds, railWidgetId, randomResourceKind, randomShellModes } from "../mock-data/data";
...
const setupNotesMode = (ctx: ShellModeActivationContext): Disposable[] => {
