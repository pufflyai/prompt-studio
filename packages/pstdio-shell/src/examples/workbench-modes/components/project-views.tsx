...
export const ProjectOverview = (props: { input: ShellWidgetRenderInput }) => {
  ...
  return (
    <ScrollArea h="full" minH="0" contentProps={{ p: "lg" }}>
      <Stack gap="lg" w="full" maxW="3xl">
        <Stack gap="xs">
          <HStack gap="xs">
            <ShellIcon name={workbenchModes.project.icon} size={20} />
        ...
        <Grid templateColumns={{ base: "1fr", md: "repeat(3, minmax(0, 1fr))" }} gap="md">
          {[
            ...
            <Box key={metric.label} borderWidth="1px" borderColor="border.muted" borderRadius="sm" p="sm">
              <HStack gap="xs">
                <ShellIcon name={metric.icon} size={14} color="fg.muted" />
...
export const ProjectFeed = () => (
  <ScrollArea h="full" minH="0" contentProps={{ p: "md" }}>
    <Stack gap="xs" w="full">
      <HStack gap="xs">
        <ShellIcon name="Activity" size={14} color="fg.muted" />
