...
const findActiveFile = (input: ShellWidgetRenderInput) => {
...
export const WorkspaceEditor = (props: { input: ShellWidgetRenderInput }) => {
  ...
  return (
    <Stack h="full" minH="0" gap="0">
      <HStack
        ...
        gap="xs"
      >
        <ShellIcon name="FileCode" size={14} color="fg.muted" />
...
export const WorkspaceDiff = (props: { input: ShellWidgetRenderInput }) => {
  const file = findActiveFile(props.input);
  ...
  return (
    <ScrollArea h="full" minH="0" contentProps={{ p: "md" }}>
      <Stack gap="sm" w="full">
        <HStack gap="xs">
          <ShellIcon name="GitCompare" size={14} color="fg.muted" />
          <Text textStyle="label/S/medium" color="fg">
            Diff preview
          </Text>
        </HStack>
...
export const WorkspaceMainHeader = () => (
  <HStack h="full" px="sm" gap="sm">
    <ShellIcon name={workbenchModes.workspace.icon} size={16} />
    <Text textStyle="label/S/medium" color="fg">
      Workspace mode
    </Text>
