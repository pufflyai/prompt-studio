...
export const projectItems: ProjectItem[] = [
  ...
  },
  {
    ...
    status: "open",
    body: "Render runtime extension webviews inside the shell host.",
  },
  {
    id: "ps-268",
...
export const terminalLines = [
  "$ bun run validate",
  "[shell] type check ............... PASS",
  "[shell] tests .................... 124 passed",
  "[shell] storybook build .......... ok",
  "$ _",
];
...
export const settingsFields: SettingsField[] = [
  ...
  { id: "default-mode", label: "Default mode", hint: "Mode to activate on shell load", value: "project" },
