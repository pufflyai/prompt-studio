import type { Disposable, ShellModeActivationContext, ShellModuleContributionContext } from "../../../core";
import { SettingsPage, SettingsStatus, SettingsTabs } from "../components/settings-views";
import { settingsWidgetIds, workbenchModes } from "../mock-data/data";

const setupSettingsMode = (ctx: ShellModeActivationContext): Disposable[] => {
...
export const registerSettingsMode = (ctx: ShellModuleContributionContext) => {
