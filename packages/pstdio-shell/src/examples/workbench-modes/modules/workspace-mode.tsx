...
const setupWorkspaceMode = (ctx: ShellModeActivationContext): Disposable[] => {
  const disposables: Disposable[] = [
    ...
    ctx.trees.registerTreeView({
      ...
      area: "main-left",
      getRoots: () => [],
      getSections: () => buildWorkspaceTreeSections(),
      getChildren: () => [],
    }),
...
export const registerWorkspaceMode = (ctx: ShellModuleContributionContext) => {
