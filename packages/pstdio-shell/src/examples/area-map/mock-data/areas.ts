import type { ResourceRef, ShellArea } from "../../../core";

export const areaResourceKind = "shell-area";
...
export const createAreaResource = (area: ShellArea, input: AreaResourceInput = {}): ResourceRef => ({
...
export const areaWidgetId = (area: ShellArea) => `area-map.${area}`;
