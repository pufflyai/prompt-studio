...
const registerResourceProviders = (ctx: ShellModuleContributionContext) => {
  ctx.resources.registerProvider({
    id: "dashboard-shell.tickets",
    kind: "ticket",
    list: () => dashboardTickets.map(({ resource }) => ({ resource, group: "Tickets" })),
  });

  ctx.resources.registerProvider({
    id: "dashboard-shell.dashboard-views",
    kind: "dashboard-view",
    list: () => [{ resource: dashboardResources.tickets, group: "Dashboard" }],
  });

  ctx.resources.registerProvider({
    id: "dashboard-shell.extension-routes",
  ...
  ctx.resources.registerProvider({
    id: "dashboard-shell.project-settings",
