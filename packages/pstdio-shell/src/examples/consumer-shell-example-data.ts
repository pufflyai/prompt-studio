...
export const shellLifecyclePhases = ["activate", "reload"] as const;

export const shellPreferenceNames = [
...
export const shellWidgetIds = {
  overview: "project.overview",
  tickets: "project.tickets",
  workspace: "project.workspace",
  settings: "project.settings",
  registryInventory: "shell.registry.inventory",
...
export const shellExampleResources = {
  ...
  ticket266: createResource("ticket", "PS-266", "PS-266 Shell examples", "Ticket"),
...
export const shellExampleTickets = [
  {
    id: "PS-266",
    title: "Move shell stories into examples",
    status: "In progress",
    severity: "warning",
  ...
  },
  {
    ...
    status: "Ready",
    severity: "info",
    resource: shellExampleResources.ticket267,
  },
  {
    id: "PS-268",
