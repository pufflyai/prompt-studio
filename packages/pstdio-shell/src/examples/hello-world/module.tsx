import { headerTrailingMenuPath, type ShellModuleContribution } from "../../core";
...
export const createHelloWorldModule = (): ShellModuleContribution => ({
  id: "hello-world",
  activate(ctx) {
    ...
    ctx.renderers.registerRenderer({
      id: welcomeWidgetId,
      render: () => <ExamplePanel title="Hello world" description="A shell module rendered into the main area." />,
    });
