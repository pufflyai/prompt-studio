...
const isPlacementCloseable = (placement: ShellWidgetPlacement) => placement.closable === true;

export const shouldShowAreaTabs = (placements: ShellWidgetPlacement[]) =>
                ...
                {closable ? (
                  <CloseButton
                    ...
                    onClick={(event) => {
                      ...
                      shell.layout.closeWidget(placement.widgetId);
                    }}
                  />
                ) : null}
              </Tabs.Trigger>
