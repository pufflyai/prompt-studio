...
workbench.registerModule({
  ...
  activate(ctx) {
    ...
    void ctx.resources.openResource(createExtensionDataRendererResource(ticketsRecord, PROJECT_ID));
    return disposables;
  },
});

const meta = {
  title: "Extensions/DataRendererBoard",
...
// workbench data-renderer adapter path. The board, attributes, and rows all
