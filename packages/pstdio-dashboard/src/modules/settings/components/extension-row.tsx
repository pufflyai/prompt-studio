...
import { ExtensionDiagnostics } from "./extension-diagnostics";
...
export const ExtensionRow = (props: ExtensionRowProps) => {
  const { extension, diagnostics, toggling, uninstalling, toggleAriaLabel, uninstallLabel, onToggle, onUninstall } =
    props;
