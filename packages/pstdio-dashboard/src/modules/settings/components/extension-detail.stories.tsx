  ...
  args: {
    extension: {
      ...
      lastError: {
        ...
        message:
          'Extension "pstdio-planner" was built for extension API 1.0.0-alpha.3, but this host provides 1.0.0-alpha.5. Update the extension with `pst extensions update pstdio-planner`, or reinstall it with `pst extensions add`.',
      },
    },
  },
};
