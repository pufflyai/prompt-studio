...
export const getProjectTemplateAssets = async (projectId: string): Promise<ProjectTemplateAsset[]> => {
  ...
  return templates.map((t) => ({
    ...
    extensionId: t.extension_id ?? null,
    extensionName: t.extension_name ?? null,
    templateKey: t.template_key ?? null,
...
export const createProjectTemplate = async (
  ...
  return {
    ...
    extensionId: created.extension_id ?? null,
    extensionName: created.extension_name ?? null,
    templateKey: created.template_key ?? null,
