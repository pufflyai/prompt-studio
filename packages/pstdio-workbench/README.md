...
- **Widget placement**: an opened instance of a widget contribution in an area. Areas track their active placement; the layout derives the effective widget from its active slot. Placements carry resource URI, title, pinned/closable flags, and placement ownership.
