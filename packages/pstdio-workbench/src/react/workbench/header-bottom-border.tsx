...
// the panel content below. Hosting headers must set `position="relative"`.
export const WorkbenchHeaderBorder = (props: WorkbenchHeaderBorderProps) => {
  ...
  return <Box position="absolute" insetInline="0" bottom="0" h="1px" bg="border.muted" pointerEvents="none" />;
};
