...
export const resolveDataRendererStorageKey = (dataRendererId: string, placement: WorkbenchWidgetPlacement) => {
  const baseKey = `pstdio:workbench:dataRenderer:${dataRendererId}:${placement.widgetId}`;
