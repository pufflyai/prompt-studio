...
interface WorkbenchModeRegistryInternals {
  activatePageMode(modeId: string | undefined): void;
}
...
export const activateWorkbenchPageMode = (registry: WorkbenchModeRegistry, modeId: string | undefined) => {
  ...
  internals.activatePageMode(modeId);
};
