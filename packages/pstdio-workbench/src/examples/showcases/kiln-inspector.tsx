...
const SceneOutliner = (props: { input: WorkbenchPanelRenderInput; selectedId: string }) => {
    ...
    <Stack minH="0" gap="0">
      ...
      <Stack p="xs" gap="2xs" overflowY="auto">
        <HStack ps="xs" color="fg.muted">
          <WorkbenchIcon name="ChevronDown" size={12} />
          <WorkbenchIcon name="Boxes" size={13} />
          ...
          return (
            <HStack key={object.id} gap="2xs">
              <Button
                ...
                onClick={() =>
                  input.workbench.pageLocations.navigate({
                    kind: "page",
                    page: kilnPage,
              ...
              >
                <WorkbenchIcon name={object.icon} />
              ...
              >
                <WorkbenchIcon name={visible ? "Eye" : "EyeOff"} />
              </IconButton>
            </HStack>
          );
        })}
...
export const KilnInspector = (props: { input: WorkbenchPanelRenderInput }) => {
  const { input } = props;
  const state = useShowcaseStore(kilnStore);
  const selectedId = usePrimaryResource(input.workbench)?.id ?? kilnObjects[0].id;
        ...
        <HStack justify="space-between">
          <HStack minW="0">
            <Box
              ...
              flexShrink={0}
            >
              <WorkbenchIcon name={object.icon} color="white" />
            </Box>
            <Stack minW="0" gap="0">
