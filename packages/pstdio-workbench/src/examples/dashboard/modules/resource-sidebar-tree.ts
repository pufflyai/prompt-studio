...
import { dashboardChangedFilePaths, dashboardTickets, dashboardWidgetIds } from "../mock-data/data";
...
export const registerDashboardResourceSidebarTree = (ctx: WorkbenchModuleContributionContext) => {
