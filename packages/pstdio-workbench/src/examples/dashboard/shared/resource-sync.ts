...
export const syncResourceSidenav = (ctx: WorkbenchModuleContext, resource: ResourceRef) => {
  ctx.layout.clearRegion("sidenav");
  ctx.layout.openPanel(dashboardWidgetIds.ticketSidenav, { resource, title: resource.label, pinned: true });
