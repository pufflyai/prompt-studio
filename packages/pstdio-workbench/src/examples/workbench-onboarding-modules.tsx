...
import { onboardingTreeSections } from "./workbench-onboarding-tree-sections";
...
const registerGuideWidget = (ctx: WorkbenchModuleContributionContext, options: { singleton?: boolean } = {}) => {
