...
import type { RawLogEvent, SessionMessage } from "pstdio-agents";
...
export const buildSpawnArgs = (input: HarnessSessionMessageInput) => {
...
export const createMessageAccumulator = (eventStore: HarnessEventStore, options: AccumulatorOptions = {}) => {
...
export const spawnClaudeCodeSession = async (input: HarnessSessionStartInput, deps: SpawnDeps = defaultDeps) => {
  ...
  return {
    ...
    } satisfies HarnessSpawnedProcess,
  };
};
