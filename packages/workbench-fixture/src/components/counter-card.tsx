        ...
        <HStack justify="space-between" align="center" wrap="wrap" gap="md">
          ...
          <HStack gap="xs" wrap="wrap">
            <Button
              type="button"
              variant="outline"
              onClick={() => runCounterCommand("pstdio.workbench-fixture.command.counter.bump", { amount: -1 })}
            ...
            <Button
              type="button"
              variant="primary"
              onClick={() => runCounterCommand("pstdio.workbench-fixture.command.counter.bump")}
            ...
            <Button
              type="button"
              variant="ghost"
              onClick={() => runCounterCommand("pstdio.workbench-fixture.command.counter.reset")}
              disabled={isPending}
            >
              Reset
            </Button>
