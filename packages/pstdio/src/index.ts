...
const cliVersion = resolveCliVersion({ envVersion: process.env.PSTDIO_VERSION, packageVersion });

if (!process.env.PSTDIO_VERSION) {
  process.env.PSTDIO_VERSION = cliVersion;
}
