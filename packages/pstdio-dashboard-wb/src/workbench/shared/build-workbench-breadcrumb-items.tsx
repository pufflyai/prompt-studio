...
import type { FavoriteScopeInput, ResourceRef, WorkbenchBreadcrumbItem, WorkbenchCore } from "pstdio-workbench/core";
...
export const buildWorkbenchBreadcrumbItems = (workbench: WorkbenchCore, items: WorkbenchBreadcrumbItem[] | undefined) =>
  (items ?? []).map((item) => ({
