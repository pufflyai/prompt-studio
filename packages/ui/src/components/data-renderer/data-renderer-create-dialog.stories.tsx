...
import type { AttributeDescriptor, DataRendererCreateRowConfig, DataRendererCreateSubmission } from "./types";
...
const config: DataRendererCreateRowConfig = {
  title: "New ticket",
...
const meta = {
  title: "Data Renderer/Create Dialog",
  component: DataRendererCreateDialog,
  parameters: { layout: "fullscreen" },
} satisfies Meta<typeof DataRendererCreateDialog>;
