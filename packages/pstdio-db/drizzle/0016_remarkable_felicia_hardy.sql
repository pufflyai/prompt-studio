...
CREATE INDEX "extension_instances_scope_namespace_idx" ON "extension_instances" USING btree ("scope_type","scope_id","namespace");--> statement-breakpoint
CREATE INDEX "installed_ext_install_name_idx" ON "installed_extension_sources" USING btree ("install_name");--> statement-breakpoint
CREATE UNIQUE INDEX "installed_ext_source_path_uq" ON "installed_extension_sources" USING btree ("source_path");