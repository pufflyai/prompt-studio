...
ALTER TABLE "notifications" ADD CONSTRAINT "notifications_source_extension_id_installed_extension_sources_id_fk" FOREIGN KEY ("source_extension_id") REFERENCES "public"."installed_extension_sources"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
