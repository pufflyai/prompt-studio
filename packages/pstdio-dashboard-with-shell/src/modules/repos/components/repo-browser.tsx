...
export interface RepoBrowserMenuOption {
  label: string;
  value: string;
...
interface RepoBrowserProps {
  repositoryOptions: RepoBrowserMenuOption[];
  selectedRepository: string;
  onSelectRepository: (repository: string) => void;
  branchOptions: RepoBrowserMenuOption[];
...
interface RepoBrowserMenuItem extends SearchableMenuItem {
  icon: NonNullable<RepoBrowserMenuOption["icon"]>;
}

const getSelectedLabel = (
  options: RepoBrowserMenuOption[],
