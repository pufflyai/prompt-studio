...
import { type WorkspaceProviderDescriptor, workspaceProviderDescriptorSchema } from "pstdio-api-contracts";
...
export const listWorkspaceProvidersHandler =
  ...
  async (c) =>
    c.json((await listWorkspaceProviders(deps, c.req.valid("param").projectId)) as WorkspaceProviderDescriptor[], 200);
