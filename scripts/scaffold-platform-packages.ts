...
const TARGETS = [
  ...
  { pkg: "cli-linux-x64", name: "@pstdio/cli-linux-x64", os: "linux", cpu: "x64", bin: "pstdio" },
  { pkg: "cli-linux-arm64", name: "@pstdio/cli-linux-arm64", os: "linux", cpu: "arm64", bin: "pstdio" },
  { pkg: "cli-linux-x64-musl", name: "@pstdio/cli-linux-x64-musl", os: "linux", cpu: "x64", bin: "pstdio" },
  { pkg: "cli-linux-arm64-musl", name: "@pstdio/cli-linux-arm64-musl", os: "linux", cpu: "arm64", bin: "pstdio" },
...
for (const { pkg, name, os, cpu, bin } of TARGETS) {
